...
class Model
{
    ...
    public function __construct()
    {
        try {
            ...
            error_log("PMBOK Model - Database connection error: " . $e->getMessage());
            $this->db = null;
        }
    }
     ...
     * دریافت تمام رکوردها
     */
    public function getAll($limit = null, $offset = 0, $orderBy = 'id', $order = 'ASC')
    {
        if (!$this->db) return [];
