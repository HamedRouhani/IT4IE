...
/**
 * ============================================================
 * BaseModel - مدل پایه ماژول Quality Analyzer
 * ============================================================
 * مسیر: app/software/quality/app/Models/BaseModel.php
 *
 * این کلاس پایه تمام Modelهای ماژول Quality است و:
...
abstract class BaseModel
{
    ...
    public function __construct(?int $systemId = null)
    {
        ...
        if ($systemId === null) {
            $systemId = !empty($_SESSION['qc_active_system'])
                ? (int) $_SESSION['qc_active_system']
                : null;
        }
