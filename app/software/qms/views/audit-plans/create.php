...
// دریافت داده‌ها از session (پس از redirect در صورت وجود خطا)
            ...
            <div class="row" style="display: flex; gap: 20px; margin-bottom: 20px;">
                <div class="col-md-6" style="flex: 1;">
                    <div class="form-group">
                        ...
                        <!-- فیلد مخفی که مقدار میلادی را به سرور می‌فرستد -->
                        <input type="hidden" 
                               name="start_date" 
                        ...
                        <small style="color: #718096; font-size: 0.8rem; margin-top: 4px; display: block;">
                            میلادی: <span id="start_date_preview"><?= htmlspecialchars($oldStartDate) ?></span>
                        </small>
                    </div>
                </div>
                <div class="col-md-6" style="flex: 1;">
                    <div class="form-group">
                        ...
                        <small style="color: #718096; font-size: 0.8rem; margin-top: 4px; display: block;">
                            میلادی: <span id="end_date_preview"><?= htmlspecialchars($oldEndDate) ?></span>
                        </small>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    // ✅ تابع اصلاح‌شده تبدیل اعداد فارسی به انگلیسی
    ...
    $('#auditPlanForm').on('submit', function(e) {
        var startDate = $('#start_date_gregorian').val();
        var endDate = $('#end_date_gregorian').val();
        
        console.log('Submit - Start:', startDate, 'End:', endDate);
