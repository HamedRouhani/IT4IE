...
/**
 * ============================================================
 * BaseModel - مدل پایه ماژول PdM
 * ============================================================
 * مسیر: app/software/pdm/app/Models/BaseModel.php
 * 
 * این کلاس پایه تمام Modelهای ماژول PdM است و:
...
abstract class BaseModel
{
    ...
    public function __construct(?int $systemId = null)
    {
        ...
        if ($systemId === null) {
            $systemId = !empty($_SESSION['pdm_active_system'])
                ? (int) $_SESSION['pdm_active_system']
                : null;
        }
