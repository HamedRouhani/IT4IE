...
/**
 * ============================================================
 * Entry Point ماژول PdM Analyzer
 * ============================================================
 * مسیر: app/software/pdm/index.php
 * URL: /software/pdm-analyzer/
 * ============================================================
 */
...
if (!defined('CURRENT_MODULE')) {
    define('CURRENT_MODULE', 'pdm');
}
if (!defined('CURRENT_MODULE_URL')) {
    define('CURRENT_MODULE_URL', '/software/pdm-analyzer/');
}
...
// ============================================
// AUTOLOADER ماژول PdM
// ============================================
spl_autoload_register(function ($class) {
    // Namespace اختصاصی ماژول PdM
    $prefix = 'App\Software\Pdm\\';
    ...
    if (strpos($class, $legacyPrefix) === 0) {
        ...
        // ⚠️ جستجو با نام کوچک (برای سازگاری با لینوکس)
        $lowerPath = strtolower($classPath);
        $lowerFile = dirname(dirname(dirname(__DIR__))) . '/app/' . $lowerPath;
...
// ============================================
// لود DateHelper به صورت مستقیم
// مسیر: app/helpers/DateHelper.php  (با h کوچک)
// ============================================
...
$controllerMap = [
    ...
    'asset_category' => 'AssetCategoryController',
    'spare_part'     => 'SparePartController',
...
try {
    ...
    $controllerClass = 'App\\Software\\Pdm\\Controllers\\' . $controllerMap[$controllerKey];
    ...
    error_log("PdM Module Error: " . $e->getMessage() . " in " . $e->getFile() . ":" . $e->getLine());
    ...
    if ($isAjax) {
        ...
        echo '<h1 style="color:#e74c3c;">❌ خطا در ماژول PdM Analyzer</h1>';
