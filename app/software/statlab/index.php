...
/**
 * ============================================================
 * Entry Point ماژول StatLab Analyzer
 * ============================================================
 * مسیر: app/software/statlab/index.php
...
if (!defined('CURRENT_MODULE')) {
    define('CURRENT_MODULE', 'statlab');
}
if (!defined('CURRENT_MODULE_URL')) {
    define('CURRENT_MODULE_URL', '/software/statlab-analyzer/');
}
...
// ============================================
// AUTOLOADER ماژول StatLab
// ============================================
spl_autoload_register(function ($class) {
    // Namespace ماژول StatLab
    $prefix = 'App\Software\Statlab\\';
    ...
    // Namespace عمومی (سازگاری با Core اصلی)
    $legacyPrefix = 'App\\';
...
$controllerMap = [
    ...
    'hypothesis'         => 'HypothesisController',
    'regression'         => 'RegressionController',
    'smart_statistician' => 'SmartStatisticianController',
...
try {
    ...
    $controllerClass = 'App\\Software\\Statlab\\Controllers\\' . $controllerMap[$controllerKey];
    ...
    error_log("StatLab Module Error: " . $e->getMessage() . " in " . $e->getFile() . ":" . $e->getLine());
    ...
    if ($isAjax) {
        ...
        echo '<h1 style="color:#e74c3c;">❌ خطا در ماژول StatLab Analyzer</h1>';
