...
<div class="software-content hr-fade-in">
    ...
    <div class="hr-flex-between hr-mb-4">
        <div>
            <h2 style="color: var(--hr-primary-dark); margin: 0;">
                <i class="fas fa-phone-alt"></i> افزودن تماس اضطراری
            </h2>
        </div>
    ...
    <form method="POST" action="<?= hr_url('employee_contact', 'store') ?>">
        <?= $this->csrfField() ?>
        ...
        <div class="card hr-mb-3">
            ...
            <div class="card-body">
                ...
                <div class="hr-form-row">
                    <div class="hr-form-group">
                        <label class="hr-form-label" for="contact_name">
                            نام مخاطب <span style="color: var(--hr-danger);">*</span>
                        </label>
                    ...
                    <div class="hr-form-group">
                        ...
                        <input type="text" id="relation" name="relation"
                               class="hr-form-control"
                               placeholder="مثال: همسر، پدر، مادر، برادر"
                               maxlength="100">
                    </div>
                </div>
                ...
                <div class="hr-form-group">
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        ...
                        <span>مخاطب اصلی (تماس اضطراری اول)</span>
                    </label>
                </div>
            </div>
        </div>
